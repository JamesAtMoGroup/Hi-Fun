  ...
  return (
    <ScrollView className="flex-1 bg-white">
      ...
      <View className="items-center py-8 px-6">
        <View className="w-64 h-64 border-2 border-dashed border-gray-300 rounded-2xl items-center justify-center bg-gray-50">
      ...
      {/* Ticket info */}
      <View className="px-6 py-4 bg-gray-50 mx-4 rounded-xl mb-4">
        <View className="flex-row justify-between items-center mb-3">
          <Text className="text-sm text-gray-500">{t('tickets.ticketType')}</Text>
          <Text className="text-sm font-semibold text-gray-900">
            {ticket.ticketType}
          </Text>
        </View>
        <View className="flex-row justify-between items-center mb-3">
          <Text className="text-sm text-gray-500">{t('tickets.price')}</Text>
          <Text className="text-sm font-semibold text-gray-900">
        ...
        <View className="flex-row justify-between items-center">
          <Text className="text-sm text-gray-500">{t('tickets.status')}</Text>
